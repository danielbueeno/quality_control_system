...
from settings import MIN_WEIGHT,MAX_WEIGHT, REPORT_DIR, MIN_LENGTH, MAX_LENGTH, ALLOWED_COLORS
from persistence import save_box, save_rejects, _ensure_dirs, load_state
